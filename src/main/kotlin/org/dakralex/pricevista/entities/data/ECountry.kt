...
enum class ECountry(val country: Country) {
    ...
    BO(Country( 68, "BO", "BOL", "068", "Bolivia (Plurinational State of)")),
    ...
    VG(Country( 92, "VG", "VGB", "092", "Virgin Islands (British)")),
    ...
    TW(Country(158, "TW", "TWN", "158", "Taiwan, Province of China[a]")),
    ...
    CD(Country(180, "CD", "COD", "180", "Congo (Democratic Republic of the)")),
    ...
    CZ(Country(203, "CZ", "CZE", "203", "Czech Republic")),
    ...
    PS(Country(275, "PS", "PSE", "275", "Palestine, State of")),
    ...
    IR(Country(364, "IR", "IRN", "364", "Iran (Islamic Republic of)")),
    ...
    KP(Country(408, "KP", "PRK", "408", "Korea (Democratic People's Republic of)")),
    KR(Country(410, "KR", "KOR", "410", "Korea (Republic of)")),
    KW(Country(414, "KW", "KWT", "414", "Kuwait")),
    KG(Country(417, "KG", "KGZ", "417", "Kyrgyzstan")),
    LA(Country(418, "LA", "LAO", "418", "Lao People's Democratic Republic")),
    ...
    MD(Country(498, "MD", "MDA", "498", "Moldova (Republic of)")),
    ...
    SX(Country(534, "SX", "SXM", "534", "Sint Maarten (Dutch part)")),
    ...
    FM(Country(583, "FM", "FSM", "583", "Micronesia (Federated States of)")),
    ...
    RU(Country(643, "RU", "RUS", "643", "Russian Federation")),
    ...
    MF(Country(663, "MF", "MAF", "663", "Saint Martin (French part)")),
    ...
    SY(Country(760, "SY", "SYR", "760", "Syrian Arab Republic")),
    ...
    MK(Country(807, "MK", "MKD", "807", "Macedonia (the former Yugoslav Republic of)")),
    EG(Country(818, "EG", "EGY", "818", "Egypt")),
    GB(Country(826, "GB", "GBR", "826", "United Kingdom of Great Britain and Northern Ireland")),
    GG(Country(831, "GG", "GGY", "831", "Guernsey")),
    JE(Country(832, "JE", "JEY", "832", "Jersey")),
    IM(Country(833, "IM", "IMN", "833", "Isle of Man")),
    TZ(Country(834, "TZ", "TZA", "834", "Tanzania, United Republic of")),
    US(Country(840, "US", "USA", "840", "United States of America")),
    VI(Country(850, "VI", "VIR", "850", "Virgin Islands (U.S.)")),
    BF(Country(854, "BF", "BFA", "854", "Burkina Faso")),
    UY(Country(858, "UY", "URY", "858", "Uruguay")),
    UZ(Country(860, "UZ", "UZB", "860", "Uzbekistan")),
    VE(Country(862, "VE", "VEN", "862", "Venezuela (Bolivarian Republic of)")),
