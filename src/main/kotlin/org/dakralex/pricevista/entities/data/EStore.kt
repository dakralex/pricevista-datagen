...
enum class EStore(val store: Store) {
    ...
    HOFER(Store(2, ERetailer.HOFER.retailer, EPlace.AUT_GENERAL.place, ECurrency.EUR.currency, ELanguage.DE.language)),
    SPAR(Store(3, ERetailer.SPAR.retailer, EPlace.AUT_GENERAL.place, ECurrency.EUR.currency, ELanguage.DE.language)),
}
//@formatter:on
